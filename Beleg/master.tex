...
\thispagestyle{empty} 
 ...
 {\normalsize der Hochschule Zittau/Görlitz (HAW)\\}
 \vspace{1cm}
 {\normalsize als Prüfungsleistung im Fach\\}
 ...
 Ingo Körner (40586)\\}
 \vspace{1cm}
 {\normalsize  Görlitz, 11. Juli 2012\\}
 \vspace{0.5cm}
...
\bibitem{bib2}{Freeman, Eric (2007): Entwurfsmuster von Kopf bis Fuß. O'REILLY}
...
\chapter{Theorie}
\input{Ingo/Einleitung}
\input{Ingo/Aufgabenstellung}
\input{Ingo/RelevanzForschungsgegenstand}
\input{Ingo/AktuellerWissensstand}
\input{Ingo/Testrechner}
\input{Ingo/AufbauAT}
\input{Ingo/ARFF}
\input{Christof/Clustering}
\chapter{Umsetzung}\label{Umsetzung}
\input{Ingo/ATzuARFF}
\input{Ingo/WelcheWoerter}
\input{Ingo/Probleme}
\input{Ingo/SimpleKMeans}
\input{Ingo/weitereClusterAlg}
\input{Ingo/Text2ClusterFile}
\input{Ingo/nachVersenGeclustert}
\input{Ingo/Zusammenfassung}
\input{Ingo/Ausblick}
...
\begin{tabular}{@{}p{6.0cm}p{6.0cm}}	  		  		 	
	  		 ...
	  		 & \\
				 ...
				 &\\
				 & \\
				  			\textbf{Körner, Ingo}   	&                     Unterschrift:\\			
\end{tabular}
\end{document}
